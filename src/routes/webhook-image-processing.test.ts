...
const send=vi.fn();
const env={LINE_CHANNEL_ACCESS_TOKEN:'token',EVENT_INTAKES:{},DB:{},AI:{},IMAGE_PROCESSING_QUEUE:{send},LINE_IMAGE_BATCH_WINDOW_SECONDS:'15',LINE_TEXT_CONTEXT_WINDOW_SECONDS:'600'} as unknown as WorkerEnv;

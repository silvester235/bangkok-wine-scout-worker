/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e2c30a20d6f0da73a5b8c729b6691d36)
...
interface __BaseEnv_Env {
	...
	EDITORIAL_VISION_MODEL: "@cf/mistralai/mistral-small-3.1-24b-instruct";
	CLOUDFLARE_ACCOUNT_ID: "5043abe3e62c4f0f4beed6b298a238f1";
	HIGH_THRESHOLD: "0.85";
	LOW_THRESHOLD: "0.45";
	AI_TIMEOUT_MS: "5000";
	LINE_TEXT_CONTEXT_WINDOW_SECONDS: "600";
	LINE_IMAGE_BATCH_WINDOW_SECONDS: "15";
	LINE_MESSAGE_BATCH_WINDOW_SECONDS: "60";
	AGENT_SUBMISSION_WINDOW_SECONDS: "60";
	AGENT_DONE_SETTLEMENT_SECONDS: "3";
	PUBLIC_SITE_ORIGIN: "https://bangkok-wine-scout.silvester235.workers.dev";
	INGESTION_MODE: "v2";
	V2_PUBLICATION_ENABLED: "true";
	WINE_SCOUT_SUBMISSION_WORKFLOW: Workflow<Parameters<import("./src/index").WineScoutSubmissionWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_PROVIDER" | "AI_MODEL" | "EDITORIAL_VISION_MODEL" | "CLOUDFLARE_ACCOUNT_ID" | "HIGH_THRESHOLD" | "LOW_THRESHOLD" | "AI_TIMEOUT_MS" | "LINE_TEXT_CONTEXT_WINDOW_SECONDS" | "LINE_IMAGE_BATCH_WINDOW_SECONDS" | "LINE_MESSAGE_BATCH_WINDOW_SECONDS" | "AGENT_SUBMISSION_WINDOW_SECONDS" | "AGENT_DONE_SETTLEMENT_SECONDS" | "PUBLIC_SITE_ORIGIN" | "INGESTION_MODE" | "V2_PUBLICATION_ENABLED">> {}
}
